...
The extra space in the sorting approach is problem-specific, not pattern-specific.
...
If indices are required:

Extra space is unavoidable, regardless of approach.
